...
import { useCurrentUser, useLogout } from "@/hooks/queries/use-auth.query";
import { PiUserCircleGear, PiSignOut } from "react-icons/pi";
      ...
      <DropdownMenuContent className="max-w-64" align="end">
        ...
        <DropdownMenuGroup>
          <DropdownMenuItem onClick={() => router.push(routes.admin.profile)}>
            <PiUserCircleGear size={16} className="opacity-60" aria-hidden="true" />
        ...
        <DropdownMenuItem onClick={handleSignOut}>
          <PiSignOut size={16} className="opacity-60" aria-hidden="true" />
          <span>Sign out</span>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
